...
function initSwipers() {
  ...
  // section-5 Swiper
  const section5SwiperEl = document.querySelector(
    ".section-5__swiper-container",
  );

  if (section5SwiperEl) {
    const section5PaginationEl = section5SwiperEl.querySelector(
    ...
    swiperInstances.section5 = new Swiper(section5SwiperEl, {
      ...
      on: {
        init: function () {
          ...
          const realSlideCount = section5SwiperEl.querySelectorAll(
        ...
        slideChange: function () {
          ...
          const bullets = section5SwiperEl.querySelectorAll(
